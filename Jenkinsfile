...
tag = 'latest'
name = 'bizon360crm'
project_name = 'dotnet-dev-bizon360crm'
registry = "dotnetteam/bizon360crm"
ip = '192.168.1.45'
port = '8122'
storage_type = 'nfs'
storage_size = '5Gi'
...
timestamps {
  ...
  podTemplate(label: label,
    ...
    echo "${name} has been deloyed at the following address: https://bizon360crm.dev.indrivo.com"
