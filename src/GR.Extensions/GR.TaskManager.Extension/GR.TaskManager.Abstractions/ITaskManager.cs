...
namespace GR.TaskManager.Abstractions
{
    public interface ITaskManager
    {
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<ResultModel<PagedResult<GetTaskViewModel>>> GetAllUserTasksAsync(Guid userId, string userName,PageRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<ResultModel<PagedResult<GetTaskViewModel>>> GetTaskByLeadIdAsync(Guid? leadId, PageRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<ResultModel<PagedResult<GetTaskViewModel>>> GetAllTasksByOrganizationIdPaginatedAsync(Guid? organizationId, PageRequest request);
        ...
        /// <returns></returns>
        Task<ResultModel<Guid>> CreateTaskAsync(CreateTaskViewModel task, IUrlHelper Url);

        /// <summary>
        /// Get all task by lead id
        /// </summary>
        /// <param name="leadId"></param>
        /// <returns></returns>
        Task<ResultModel<IEnumerable<GetTaskViewModel>>> GetAllTaskByLeadIdAsync(Guid? leadId);

        /// <summary>
        /// Get all task by organization id
        /// </summary>
        /// <param name="organizationId"></param>
        /// <returns></returns>
        Task<ResultModel<IEnumerable<GetTaskViewModel>>> GetAllTasksByOrganizationIdAsync(Guid? organizationId);
        ...
        /// <param name="task"></param>
        /// <returns></returns>
        Task<ResultModel> UpdateTaskAsync(UpdateTaskViewModel task, IUrlHelper Url);
        ...
        /// </summary>
        /// <returns></returns>
        Task<ResultModel<PagedResult<GetTaskViewModel>>> GetAllTasksAsync(PageRequest request, bool includeDeleted = true);
    }
}