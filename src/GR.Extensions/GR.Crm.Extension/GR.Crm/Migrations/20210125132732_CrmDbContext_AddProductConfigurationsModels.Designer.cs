...
namespace GR.Crm.Migrations
{
    ...
    [Migration("20210125132732_CrmDbContext_AddProductConfigurationsModels")]
    partial class CrmDbContext_AddProductConfigurationsModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GR.Crm.Abstractions.Models.ProductConfiguration.Services.ServiceConsultancy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GR.Crm.Abstractions.Models.ProductConfiguration.Services.ServiceDesigne", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GR.Crm.Abstractions.Models.ProductConfiguration.Services.ServiceDevelopement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GR.Crm.Abstractions.Models.ProductConfiguration.Services.ServiceQA", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GR.Crm.Leads.Abstractions.Models.ProductOrServiceList", b =>
                {
                    ...
                    b.Property<Guid?>("ServiceConsultancyId");

                    b.Property<Guid?>("ServiceDesigneId");

                    b.Property<Guid?>("ServiceDevelopementId");

                    b.Property<Guid?>("ServiceQAId");
                    ...
                    b.HasIndex("ServiceConsultancyId")
                        .IsUnique();

                    b.HasIndex("ServiceDesigneId")
                        .IsUnique();

                    b.HasIndex("ServiceDevelopementId")
                        .IsUnique();

                    b.HasIndex("ServiceQAId")
                        .IsUnique();
            ...
            modelBuilder.Entity("GR.Crm.Leads.Abstractions.Models.ProductOrServiceList", b =>
                {
                    ...
                    b.HasOne("GR.Crm.Abstractions.Models.ProductConfiguration.Services.ServiceConsultancy", "ServiceConsultancy")
                        .WithOne()
                        .HasForeignKey("GR.Crm.Leads.Abstractions.Models.ProductOrServiceList", "ServiceConsultancyId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("GR.Crm.Abstractions.Models.ProductConfiguration.Services.ServiceDesigne", "ServiceDesigne")
                        .WithOne()
                        .HasForeignKey("GR.Crm.Leads.Abstractions.Models.ProductOrServiceList", "ServiceDesigneId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("GR.Crm.Abstractions.Models.ProductConfiguration.Services.ServiceDevelopement", "ServiceDevelopement")
                        .WithOne()
                        .HasForeignKey("GR.Crm.Leads.Abstractions.Models.ProductOrServiceList", "ServiceDevelopementId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("GR.Crm.Abstractions.Models.ProductConfiguration.Services.ServiceQA", "ServiceQA")
                        .WithOne()
                        .HasForeignKey("GR.Crm.Leads.Abstractions.Models.ProductOrServiceList", "ServiceQAId")
                        .OnDelete(DeleteBehavior.SetNull);
