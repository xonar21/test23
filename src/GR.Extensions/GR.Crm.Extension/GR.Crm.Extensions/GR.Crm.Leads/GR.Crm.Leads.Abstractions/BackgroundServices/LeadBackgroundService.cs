...
namespace GR.Crm.Leads.Abstractions.BackgroundServices
{
    public class LeadBackgroundService : BaseBackgroundService<LeadBackgroundService>
    {
        ...
        public override async Task Execute(object state)
        {
            ...
            await _leadBackgroundService.NotifyUsersOnLeadExpirationAsync();
            await _leadBackgroundService.NotifyUsersOnLeadExpirationByEmailAsync();
            await _leadBackgroundService.NotifyOnDeadlineClosureAsync();
        }
