...
namespace GR.Crm.Organizations.Abstractions.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        /// <param name="services"></param>
        /// <returns></returns>
        public static IServiceCollection AddCrmPhoneListModule<TService, TContext>(this IServiceCollection services)
            where TService : class, ICrmPhoneListService
            where TContext : DbContext, ICrmOrganizationContext
        {
            services.AddGearTransient<ICrmPhoneListService, TService>();
            services.AddTransient<ICrmOrganizationContext, TContext>();
            return services;
        }
        ...
        /// <summary>
        /// Add organization revenue module
        /// </summary>
        /// <typeparam name="TService"></typeparam>
        /// <typeparam name="TContext"></typeparam>
        /// <param name="services"></param>
        /// <returns></returns>
        public static IServiceCollection AddCrmRevenueModule<TService, TContext>(this IServiceCollection services)
            where TService : class, IOrganizationRevenueService
            where TContext : DbContext, ICrmOrganizationContext
        {
            services.AddGearTransient<IOrganizationRevenueService, TService>();
            services.AddTransient<ICrmOrganizationContext, TContext>();
            return services;
        }

        /// <summary>
        /// Add organization stages module
        /// </summary>
        /// <typeparam name="TService"></typeparam>
        /// <typeparam name="TContext"></typeparam>
        /// <param name="services"></param>
        /// <returns></returns>
        public static IServiceCollection AddCrmOrganizationStagesModule<TService, TContext>(this IServiceCollection services)
            where TService : class, ICrmOrganizationHelperService
            where TContext : DbContext, ICrmOrganizationContext
        {
            services.AddGearTransient<ICrmOrganizationHelperService, TService>();
            services.AddTransient<ICrmOrganizationContext, TContext>();
            return services;
        }
    }
