...
namespace GR.Crm.Organizations.Abstractions
{
    public interface IOrganizationAddressService
    {
        ...
        Task<ResultModel<IEnumerable<CityViewModel>>> GetAllCitiesByCountryIdAsync(Guid? countryId);
       ...
       Task<ResultModel<Guid>> AddCityAsync(AddCityViewModel model);
        ...
        /// </summary>
        /// <returns></returns>
        Task<ResultModel<PagedResult<GetRegionViewModel>>> GetAllPaginatedRegionsAsync(PageRequest request);
        ...
        /// </summary>
        /// <returns></returns>
        Task<ResultModel<IEnumerable<RegionViewModel>>> GetAllRegionsByCountryIdAsync(Guid? countryId);
