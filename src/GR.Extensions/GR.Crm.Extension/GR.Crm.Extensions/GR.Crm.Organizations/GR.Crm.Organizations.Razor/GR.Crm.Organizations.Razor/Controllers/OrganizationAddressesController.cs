...
namespace GR.Crm.Organizations.Razor.Controllers
{
    ...
    public class OrganizationAddressesController : BaseGearController
    {
        ...
        [Route(DefaultApiRouteTemplate)]
        [Produces(ContentType.ApplicationJson, Type = typeof(ResultModel<IEnumerable<CityViewModel>>))]
        public async Task<JsonResult> GetAllCitiesByCountryId([Required] Guid countryId)
            => await JsonAsync(_addressService.GetAllCitiesByCountryIdAsync(countryId), SerializerSettings);
        ...
        [HttpGet]
        [Route(DefaultApiRouteTemplate)]
        [Produces(ContentType.ApplicationJson, Type = typeof(ResultModel<PagedResult<GetRegionViewModel>>))]
        ...
        [Route(DefaultApiRouteTemplate)]
        [Produces(ContentType.ApplicationJson, Type = typeof(ResultModel<IEnumerable<RegionViewModel>>))]
        public async Task<JsonResult> GetAllRegionsByCountryId([Required] Guid countryId)
            => await JsonAsync(_addressService.GetAllRegionsByCountryIdAsync(countryId), SerializerSettings);
