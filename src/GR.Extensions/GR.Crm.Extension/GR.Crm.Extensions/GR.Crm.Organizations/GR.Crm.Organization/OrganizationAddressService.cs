    ...
    public class OrganizationAddressService : IOrganizationAddressService
    {
        ...
        public virtual async Task<ResultModel<GetOrganizationAddressViewModel>> GetAddressByIdAsync(Guid? addressId)
        {
            ...
            var address = await _context.OrganizationAddresses
                ...
                .Include(i => i.City)
                .Include(i => i.City.CrmCountry)
                .Include(i => i.City.Region)
        ...
        public virtual async Task<ResultModel<Guid>> UpdateOrganizationAddressAsync(OrganizationAddressViewModel model)
        {
            ...
            organization.RegionId = model.RegionId;
        ...
        public virtual async Task<ResultModel<IEnumerable<CityViewModel>>> GetAllCitiesByCountryIdAsync(Guid? countryId)
        {
            if (countryId == null)
                return new InvalidParametersResultModel<IEnumerable<CityViewModel>>();
            ...
            var cities = await _context.Cities
                .Include(x => x.Region)
                .Where(x => x.CrmCountryId == countryId)
                .OrderBy(o => o.Name)
                .ToListAsync();
        ...
        public virtual async Task<ResultModel<Guid>> AddCityAsync(AddCityViewModel model)
        {
            ...
            var newCity = new City
            {
                Name = model.Name,
                RegionId = model.RegionId,
                CrmCountryId = model.CrmCountryId
            };
        ...
        public virtual async Task<ResultModel> UpdateCityAsync(AddCityViewModel model)
        {
            ...
            city.CrmCountryId = model.CrmCountryId;
        ...
        /// </summary>
        /// <returns></returns>
        public virtual async Task<ResultModel<PagedResult<GetRegionViewModel>>> GetAllPaginatedRegionsAsync(PageRequest request)
        {
            ...
            var map = regions.Map(_mapper.Map<IEnumerable<GetRegionViewModel>>(regions.Result));

            return new SuccessResultModel<PagedResult<GetRegionViewModel>>(map);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual async Task<ResultModel<IEnumerable<RegionViewModel>>> GetAllRegionsByCountryIdAsync(Guid? countryId)
        {
            var regions = await _context.Regions
                .Include(i => i.Cities)
                .Include(i => i.Country)
