...
namespace GR.Identity.Razor.Controllers
{
    ...
    public class LocationController : BaseGearController
    {
        ...
        /// </summary>
        /// <returns></returns>
        public IActionResult Regions(int nr = 1)
        {
            return View(nr);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public IActionResult Cities(int nr = 1)
        {
            return View(nr);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public IActionResult Countries(int nr = 1)
        {
            return View(nr);
        }
        ...
        [Produces(ContentType.ApplicationJson, Type = typeof(ResultModel<PagedResult<CountryViewModelIdentity>>))]
        public async Task<JsonResult> GetAllPaginatedCountries(PageRequest request)
            => await JsonAsync(_locationService.GetAllPaginatedCountriesAsync(request), SerializerSettings);
    }
}