...
{
    public class ApplicationDbContext : TrackerIdentityDbContext<GearUser, GearRole, string>, IIdentityContext, ICloudStorageDb
    {
        /// <summary>
        /// Schema
        /// Do not remove this
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<GearUser>().Property(x => x.DialCode).HasDefaultValue("+373");
