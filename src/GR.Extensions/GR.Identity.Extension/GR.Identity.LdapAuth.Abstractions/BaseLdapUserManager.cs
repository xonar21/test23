...
namespace GR.Identity.LdapAuth.Abstractions
{
    public abstract class BaseLdapUserManager<TLdapUser> where TLdapUser : LdapUser
    {
        ...
        /// <param name="userName"></param>
        /// <returns></returns>
        public abstract Task<ResultModel<Guid>> ImportAdUserAsync([Required] string userName);
        ...
        /// <param name="password"></param>
        /// <returns></returns>
        public abstract Task<ResultModel<Guid>> ImportAdUserAsync([Required] string userName, string password);
    }
}