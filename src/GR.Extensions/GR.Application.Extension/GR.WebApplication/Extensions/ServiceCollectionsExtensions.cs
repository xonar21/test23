    ...
    public static class ServiceCollectionsExtensions
    {
        ...
        public static IApplicationBuilder UseAppMvc(this IApplicationBuilder app, IConfiguration configuration, Dictionary<string, Action<HttpContext>> routeMapping = null)
        {
            ...
            app.UseMvc(routes =>
            {
                ...
                routes.MapRoute(
                   name: "pipeLineLeads",
                   template: "PipeLine/PipeLineLeads/{name}",
                   defaults: new { controller = "PipeLine", action = "PipeLineLeads", name = UrlParameter.Optional }
                );

                routes.MapRoute(
                   name: "leadDetails",
                   template: "{pipeline}/Leads/Details",
                    //template: "{pipeline?}/{controller=Home}/{action=Index}",
                    defaults: new { controller = "Leads", action = "Details", pipeline = UrlParameter.Optional }
               );
