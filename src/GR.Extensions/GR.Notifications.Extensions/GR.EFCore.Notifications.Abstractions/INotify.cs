...

{
        ...
        where TRole : IdentityRole<string>
    {
        ...
        /// <returns></returns>
        Task<ResultModel<IEnumerable<Notification>>> GetNotificationsByUserIdAsync(Guid userId, bool onlyUnread = true);
        ...
        /// <param name="userId"></param>
        /// <returns></returns>
        Task<ResultModel> MarkAllUserNotificationsAsReadAsync(Guid userId);
