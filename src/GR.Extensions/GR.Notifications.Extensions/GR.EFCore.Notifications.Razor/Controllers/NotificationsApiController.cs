...
namespace GR.Notifications.Razor.Controllers
{
    ...
    public class NotificationsApiController : BaseGearController
    {
        ...
        public async Task<JsonResult> GetNotificationsByUserId([Required] Guid userId, bool onlyUnread = false)
        ...
        public async Task<JsonResult> GetUserNotificationsWithPagination([Required] uint page = 1, uint perPage = 10, bool onlyUnread = false)
        ...
        [HttpPost]
        [Produces(ContentType.ApplicationJson, Type = typeof(ResultModel))]
        public async Task<JsonResult> MarkAllUserNotificationsAsRead([Required] Guid userId)
            => await JsonAsync((_notify.MarkAllUserNotificationsAsReadAsync(userId)));
    }
}