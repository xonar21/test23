Vue.component('Modal', {
	template: `<div class="modal fade" :id="modalProps.id" data-backdrop="static" role="dialog">
						...
						<div class="modal-body">
							<div class="form-inputs row custom-row">
								<component
									...
									v-bind="option.props"
									@newValue="emitValue"
									@openModal="option.props.addBtn && openModal(option.props)"
	...
	methods: {
		...
		openModal(optionProps) {
			if (optionProps.addBtn) {
				optionProps.openModal();
			}
		}
	}
})